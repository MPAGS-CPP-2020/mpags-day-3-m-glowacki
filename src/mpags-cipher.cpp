...
int main(int argc, char* argv[])
{
  ...
  // Options that might be set by the command-line argument
  ...
  CaesarCipher caesarcipher(settings.cipher_key); //make an instance of the class 

 // caesar_key = caesarcipher.key_ ;     // call object properties e.g. the data_methods it holds
  
  
  // Run the Caesar cipher (using the specified key and encrypt/decrypt flag) on the input text
  std::string outputText {caesarcipher.applyCipher(inputText, cipherMode )};
